...
// Mary:
// - added automatic stem directions in setStemDirection
// - added invisible note functionality
...
Vex.Flow.StaveNote.prototype.init = function(note_struct) {
  ...
  // Set visibility
  this.visible = (note_struct.visible == null || note_struct.visible);
...
Vex.Flow.StaveNote.prototype.setStemDirection = function(direction) {
  // TODO: decide what stem it should be
  if (!direction) {
    direction = Vex.Flow.StaveNote.STEM_UP;
    if (this.noteType != 'r' && this.keyProps[0].line > 3) {
...
Vex.Flow.StaveNote.prototype.draw = function() {
  ...
  // If it's not visible, don't draw it
